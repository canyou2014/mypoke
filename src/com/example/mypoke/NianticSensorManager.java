...
public class NianticSensorManager implements SensorEventListener {
    ...
    private float lastAzimuthUpdate,oldAzimuthUpdate;
    ...
    public NianticSensorManager(Context context, long j, ImageView imgView) {
        //super(context, j);
    ...
    @SuppressLint("NewApi") 
    private void safeCompassUpdate(long j, float f, float l) {
        //synchronized (this.callbackLock) {
    	/*
    	RotateAnimation ra = new RotateAnimation(-l, -f,  
        ...
        */
    	imgView.setRotation(-f);
    	Log.i("CompassUpdate", Double.toString(f));
    ...
    public void startSensorManager() {
        ...
        if (this.rotation != null) {
            this.sensorManager.registerListener(this, this.rotation, 2);
        }
        if (this.linearAcceleration != null) {
            this.sensorManager.registerListener(this, this.linearAcceleration, 3);
        }
        ...
        switch (sensorEvent.sensor.getType()) {
            case Sensor.TYPE_ACCELEROMETER		 /*1*/:
                ...
                if (updateOrientationFromRaw(currentTimeMillis)) {
                    safeCompassUpdate(this.lastUpdateTimeMs, this.lastAzimuthUpdate, 0);
                    break;
                }
                break;
            case Sensor.TYPE_MAGNETIC_FIELD /*2*/:
                ...
                if (updateOrientationFromRaw(currentTimeMillis)) {
                    ...
                    safeCompassUpdate(this.lastUpdateTimeMs, this.lastAzimuthUpdate, this.oldAzimuthUpdate);
                    this.oldAzimuthUpdate = this.lastAzimuthUpdate;
                    break;
                }
                break;
