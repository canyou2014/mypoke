...
public class MainActivity extends Activity{
    ...
    // 陀螺儀移動1度的圖片位移量
    private final float DISPLACEMENT = 35;//这个参数有待商榷
    ...
    private NianticSensorManager mSensorManager;
    @Override
    ...
    @SuppressLint("NewApi") private void init()
    {
        ...
        imgView.setY(400);
        imgView.setX(400);
        mSensorManager = new NianticSensorManager(this, System.currentTimeMillis(), imgView);
        mSensorManager.startSensorManager();
    }
    @SuppressLint("NewApi") 
...
*/
    ...
    protected void onStop() {
    	mSensorManager.stopSensorManager();
        super.onStop();
